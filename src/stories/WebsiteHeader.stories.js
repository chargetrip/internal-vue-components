...
const Template = (args, { argTypes }) => {
  return {
    ...
    template: `<Theme :is-web="true" :dark-mode="darkMode" style="padding: 0">
      <Banner v-if="!isBannerHidden" v-bind="$props" href="https://go.chargetrip.com" title="Discover the power of our API. Explore Chargetrip Go" description="Use the same Enterprise grade routing our customers love and trust."/>
