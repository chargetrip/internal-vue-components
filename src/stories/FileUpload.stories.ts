...
import { Story, Args } from "@storybook/vue/types-6-0";
...
const Template: Story = (_args: Args, { argTypes }) => {
  return {
    ...
    validations: {
      form: {
        ...
        fileupload2: {
          requireOneJPEG: (files: Array<File>) => {
    ...
    methods: {
      submit(): void {
        (this as HTMLFormElement).$v.$touch();
      }
    },
